...
class StockDataTransformer:
    ...
    A time window is generated by selecting timestep days of features
    columns from OHLCV data. Each time window is reshaped to:
    (int(sqrt(timestep)), int(sqrt(timestep)), len(features)).
